...
/** Category of additions for `<YXFMDatabase>` class.
...
@interface YXFMDatabase (YXFMDatabaseAdditions)
...
/** Return `int` value for query
 ...
 @note To use this method from Swift, you must include `YXFMDatabaseAdditionsVariadic.swift` in your project.
 */
...
/** The schema of the database.
 ...
 @return `YXFMResultSet` of schema; `nil` on error.
